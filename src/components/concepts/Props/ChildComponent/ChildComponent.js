const ChildComponent = (props) => {
    ...
    return(
        <div>
            <h1>Props</h1>
            <p>Props are used to pass data from a parent component to a child component, and they are the main mechanism for component communication. Props are a major part of what allows React component pattern to work.</p>
            <dl>
